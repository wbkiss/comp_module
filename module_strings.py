...
#multiplayer scene names
  ...
  ("multi_scene_enl_sandiboush", "San'di'boush ENL"),
  ("multi_scene_enl_vendetta", "Vendetta ENL"),
  ("multi_scene_enl_frostybattle", "Frosty Battle ENL"),
  ("multi_scene_enl_reveranvillage", "Reveran Village ENL"),
  ("multi_scene_enl_snowyhamlet", "Snowy Hamlet ENL"),
  ("multi_scene_mountain_fortress", "Mountain Fortress WNL"),
  ...
  ("multi_scene_verloren", "Verloren by Lord Rich"),
  ("multi_scene_glitteron_temple_summit", "Glitterond Temple Summit by TGD_Direct"),
  ("multi_scene_nord_town", "Nord Town by TGD_Direct"),
  ("multi_scene_pokonji_dol_island", "Pokonji Dol Island by Bloody Mary"),
  ("multi_scene_ramses_realm", "Ramses Realm by Spec"),
  ("multi_scene_skada_arena", "Skada Arena by TGD_Direct"),
  ("multi_scene_skodja_clearing", "Skodja Clearing by TGD_Direct"),
  ("multi_scene_the_cage", "The Cage by MadocComadrin"),
  ("multi_scene_the_hall", "The Hall by Snake"),
  ("multi_scene_tower_on_the_hill", "Tower on the Hill by Spec"),
  ("multi_scene_verovicium_army_camp", "Verovicium Army Camp by TGD_Direct"),

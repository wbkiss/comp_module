...
#multiplayer scene names
  ...
  ("multi_scene_snoops_exile_island", "Snoop's Exile Island (Mixed, Testing) by Slytacular and Zaffa"),
  ("multi_scene_low_born", "Low Born (Closed, Testing) by Romans"),
  ...
  ("multi_scene_quagmire", "Quagmire (Open, Testing) by Madoc"),

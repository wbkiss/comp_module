...
#multiplayer scene names
  ...
  ("multi_scene_snoops_exile_island", "Island Resort (Mixed, Testing) by Slytacular and Zaffa"),
  ("multi_scene_shariz_village", "Shariz Village (Closed, Testing) by Maynd"),
  ("multi_scene_liberty", "Liberty (Mixed, Testing) by Romans"),
  ("multi_scene_urabhaya", "Urabhaya (Closed, Testing) by Sotamursu"),
  ("multi_scene_rock_port", "Rock Port (Mixed, Testing) by Romans"),
  ("multi_scene_quagmire", "Quagmire (Mixed, Testing) by Madoc"),
  ("multi_scene_the_farm",  "The Farm (Open, Testing) by Romans"),
  # Unstable
  ...
  ("multi_scene_dreiecksdorf",  "Dreiecksdorf (Mixed, Unstable) by Madoc"),

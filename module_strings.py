...
#multiplayer scene names
  ...
  ("multi_scene_dry_valley", "Dry Valley by Lord Rich"),
  ("multi_scene_verloren", "Verloren by Lord Rich"),
  ("multi_scene_open_plain", "Open Plain by KissMyAxe"),
  ("multi_scene_oasis", "Oasis by Fehnor"),
  ("multi_scene_snoops_exile_island", "Island Resort by Slytacular and Zaffa"),
  ("multi_scene_shariz_village", "Shariz Village by Maynd"),
  ("multi_scene_liberty", "Liberty by Romans"),
  ("multi_scene_urabhaya", "Urabhaya by Sotamursu"),
  ("multi_scene_rock_port", "Rock Port by Romans"),
  ("multi_scene_quagmire", "Quagmire by Madoc"),
  ("multi_scene_the_farm",  "The Farm by Romans"),
  ("multi_scene_delta", "Delta by Vendigr"),
  ("multi_scene_abbey", "The Abbey by Erminas"),
  ("multi_scene_river_valley", "River Valley by Vendigr"),
  ("multi_scene_candleroot_hills", "Candleroot Hills by Mr.X"),
  ("multi_scene_lake_fort", "Lake Fort by Erminas"),
